...
require 'organization_component/controls/id'
...
require 'organization_component/controls/commands/start'

require 'organization_component/controls/events/started'
